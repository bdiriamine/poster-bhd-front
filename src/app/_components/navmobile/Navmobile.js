                    ...
                    <ul className="text-white">
                        ...
                        {user?.role === "admin" && (
                            <ul>
                                ...
                                <li><button onClick={logout} className="relative w-full text-white py-2 rounded-lg transition-all transform hover:scale-105 mb-2 overflow-hidden animated-border"> Déconnexion</button></li>
                            </ul>
                        )}
                    </ul>
                </nav>
